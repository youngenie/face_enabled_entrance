...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 28 16:37:33 2019
...
db['bdt_sjjeon_870101'].pop(10)
db['bdt_sjjeon_870101'].pop(4)
db['bdt_sjjeon_870101'].pop(18)
db['bdt_sjjeon_870101'].pop(4)
db['bdt_sjjeon_870101'].pop(8)
db['bdt_sjjeon_870101'].pop(10)
db['bdt_sjjeon_870101'].pop(10)
db['bdt_sjjeon_870101'].pop(17)
    ...
    if len(lst) > 10:
        ...
        for i in range(len(boxes)):
            ...
            if current > largest:
                ...
                j = i
                print(j)
        print('[INFO]number of faces detected: ', len(boxes))
